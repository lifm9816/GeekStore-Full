...
/**
 * Confirmar y eliminar género. Bloquea si hay productos asociados.
 */

import { useState, useTransition } from "react";
import { useRouter } from "@/i18n/navigation";
import { useTranslations } from "next-intl";
import { deleteGenre } from "@/app/actions/admin-genres";

type DeleteGenreButtonProps = {
  genreId: string;
  genreName: string;
};
  ...
  if (!confirming) {
    return (
      <button
        ...
        aria-label={t("deleteAria", { name: genreName })}
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
